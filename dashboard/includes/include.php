...
<head>
    <meta charset="utf-8">
      ...
      <title>campuschat | Responsive Bootstrap 5 Admin Dashboard Template</title>
      
      <link rel="shortcut icon" href="../assets/images/favicon.ico" />
      <link rel="stylesheet" href="../assets/css/libs.min.css">
      <link rel="stylesheet" href="../assets/css/campuschat1fc6.css?v=4.0.0">
      <link rel="stylesheet" href="../assets/vendor/%40fortawesome/fontawesome-free/css/all.min.css">
      <link rel="stylesheet" href="../assets/vendor/remixicon/fonts/remixicon.css">
      <link rel="stylesheet" href="../assets/vendor/vanillajs-datepicker/dist/css/datepicker.min.css">
      <link rel="stylesheet" href="../assets/vendor/font-awesome-line-awesome/css/all.min.html">
          ...
          <div id="sidebar-scrollbar">
              <nav class="iq-sidebar-menu">
                  <ul id="iq-sidebar-toggle" class="iq-menu">
                      ...
                      <li class=" ">
                           <a href="friend-request.html" class=" ">
              ...
              <nav class="navbar navbar-expand-lg navbar-light p-0">
                  <div class="iq-navbar-logo d-flex justify-content-between">
                      <a href="index.html">
                          ...
                          <!-- <span style="font-size: 20%;">campuschat</span> -->
                      </a>
                           ...
                           <li class="nav-item dropdown">
                              ...
                              <div class="sub-drop dropdown-menu caption-menu" aria-labelledby="drop-down-arrow">
                                  <div class="card shadow-none m-0">
                                      ...
                                      <div class="card-body p-0 ">
                                          <a href="https://templates.iqonic.design/campuschat/bs5/html/dist/app/profile.html" class="iq-sub-card iq-bg-primary-hover">
                                              <div class="d-flex align-items-center">
                                          ...
                                          <a href="https://templates.iqonic.design/campuschat/bs5/html/dist/app/profile-edit.html" class="iq-sub-card iq-bg-warning-hover">
                                              <div class="d-flex align-items-center">
                                          ...
                                          <a href="https://templates.iqonic.design/campuschat/bs5/html/dist/app/account-setting.html" class="iq-sub-card iq-bg-info-hover">
                                              <div class="d-flex align-items-center">
                                          ...
                                          <a href="https://templates.iqonic.design/campuschat/bs5/html/dist/app/privacy-setting.html" class="iq-sub-card iq-bg-danger-hover">
                                              <div class="d-flex align-items-center">
